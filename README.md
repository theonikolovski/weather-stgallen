...
6. It saves the table as a CSV file with today's date in the filename, for example: weather_stgallen_2026-04-30.csv. This file can be opened in Excel.
...
- The following Python libraries: requests, pandas (installed in Step 3)
